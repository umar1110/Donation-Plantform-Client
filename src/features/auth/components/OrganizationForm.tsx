        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              value={formData.type}
              onChange={onChange}
              className={`w-full appearance-none px-4 py-3 rounded-lg border bg-background text-foreground focus:outline-none focus:ring-2 transition-colors ${
                errors.type
                  ? "border-red-500 focus:ring-red-500/50 focus:border-red-500"
                  : "border-border focus:ring-primary/50 focus:border-primary"
              }`}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={onChange}
            placeholder="e.g., NSW, Punjab, California"
            className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground placeholder:text-muted focus:outline-none focus:ring-2 transition-colors ${
          ...
          />
          {errors.state_province && (
            <p className="mt-1 text-sm text-red-500">{errors.state_province}</p>
          )}
        </div>
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">
          ...
          <input
            ...
            value={formData.city}
            onChange={onChange}
            placeholder="e.g., Sydney, Lahore, San Francisco"
            className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground placeholder:text-muted focus:outline-none focus:ring-2 transition-colors ${
              errors.city
                ? "border-red-500 focus:ring-red-500/50 focus:border-red-500"
                : "border-border focus:ring-primary/50 focus:border-primary"
